      ...
      <div className="navbar h-[10vh] bg-base-100">
        <div className="navbar-start">
          <div className="dropdown">
            <label tabIndex={0} className="btn btn-ghost btn-circle shadow-sm hover:shadow-none">
        ...
        <div className="navbar-center">
          <Link to='/' className=" font-normal uppercase tracking-[.35em] sm:text-xl font-mono text-[#269d8b]">READSPHERE</Link>
        </div>
