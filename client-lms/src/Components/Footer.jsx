...
const Footer = () => {
  ...
  return (
    <>
   <footer className="footer items-center p-4 bg-base-200 absolute bottom-0 left-0 text-neutral-content">
  <aside className="items-center grid-flow-col">
    <FaSlackHash className=" font-bold text-4xl text-neutral "/>
    <p className=" font-light text-neutral ">Copyright © {year} - All right reserved</p>
  </aside> 
