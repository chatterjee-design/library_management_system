...
const Navbar = () => {
  return (
    <>
      <header className="navbar absolute top-0 left-0 bg-base-100 h-[10vh] my-1 flex flex-col w-[100vw]">
        <nav className='w-[100%]'>
    ...
    <a className=" font-normal tracking-[.35em] sm:text-xl font-mono ">READSPHERE <br/><span className="hidden sm:inline-flex font-light text-xs tracking-[.25em]" >Journey Through Endless Books</span> </a>
  </div>
            ...
            >
              <div class="card-body">
                ...
                <div class="card-actions">
                  <button class="btn bg-[#0F2C59] text-white hover:text-black btn-block">View cart</button>
                </div>
              </div>
            </div>
          </div>
