     ...
     <div className="flex items-center h-screen w-screen justify-center bg-login bg-cover bg-no-repeat ">
        <div className=" backdrop-blur-sm h-screen w-screen flex items-center justify-center">
          <div className="flex flex-col items-center justify-between py-5 min-h-fit h-[65%] bg-white w-[80%] md:w-2/5">
            <h1 className="uppercase font-light tracking-[.35em] sm:text-3xl font-serif text-[#269d8b]" >LogIn</h1>
            <form onSubmit={logIn} className=" flex flex-col items-center justify-evenly w-[80%] h-[100%] ">
            ...
            <p>Don't have an account? <Link to='/signUp' className=" text-[#5c269d] pt-4 cursor-pointer hover:text-[#796b87] underline font-sans">Sign Up</Link> </p>
          </div>
        </div>
      </div> 
    </>
